...
pub fn on_token_purchase(
    ...
    // Emit a message for onTokenPurchase event
    msg!(
        "onTokenPurchase: Customer={}, ETH={}, Tokens={}, ReferredBy={}",
        customer_address,
        incoming_eth,
        tokens_minted,
        referred_by
...
pub fn on_token_sell(customer_address: Pubkey, tokens_burned: u64, eth_earned: u64) -> bool {
    // Emit a message for onTokenPurchase event
    msg!(
        "onTokenSell: Customer={}, Tokens={}, ETH={}",
        customer_address,
        tokens_burned,
        eth_earned
    );
...
pub fn on_reinvestment(customer_address: Pubkey, eth_reinvested: u64, tokens_minted: u64) -> bool {
    // Emit a message for onTokenPurchase event
    msg!(
        "onReinvestment: Customer={}, ETH={}, Tokens={}",
        customer_address,
        eth_reinvested,
        tokens_minted
    );
...
pub fn on_masternode(
    ...
    // Emit a message for onTokenPurchase event
    msg!(
        "onMasternode: Customer={}, Consumer={}, ETH={}, Bonus={}",
        customer_address,
        consumer_address,
        lamport_used,
        bonus_received
